...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix='bobquest-b12-') as tmpdir:
        tmp = Path(tmpdir)
        ...
        env.update(
            {
                ...
                'BOBQUEST_FAKE_BOB_EXPECT_ANALYZE_ARGS': '--auth-method,api-key',
                'BOBQUEST_FAKE_BOB_EXPECT_EVALUATE_ARGS': '--auth-method,api-key',
                'BOBQUEST_FAKE_BOB_EXPECT_PROMPT_MODE': 'argument',
    ...
    print('B12 real Bob CLI prompt-as-argument E2E checks passed.')
